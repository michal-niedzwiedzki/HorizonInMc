    ...
    private void renderEntries(DrawContext context) {
        ...
        if (this.drawNames) {
            if (iv.questEntrySelected == 0) {
                renderer.render(context, "ACTIVE", x + 40, j);
            } else {
                renderer.render(context, "ACTIVE", x + 30, j);
            }
            j -= 5;
            if (iv.questEntrySelected == 1) {
                renderer.render(context, "MAIN", x + 40, j + 30);
            } else {
                renderer.render(context, "MAIN", x + 30, j + 30);
            }
            if (iv.questEntrySelected == 2) {
                renderer.render(context, "SIDE", x + 40, j + 55);
            } else {
                renderer.render(context, "SIDE", x + 30, j + 55);
            }
            if (iv.questEntrySelected == 3) {
                renderer.render(context, "ERRANDS", x + 40, j + 80);
            } else {
                renderer.render(context, "ERRANDS", x + 30, j + 80);
            }
            if (iv.questEntrySelected == 4) {
                renderer.render(context, "JOBS", x + 40, j + 105);
            } else {
                renderer.render(context, "JOBS", x + 30, j + 105);
            }
            if (iv.questEntrySelected == 5) {
                renderer.render(context, "SALVAGE CONTRACTS", x + 40, j + 130);
            } else {
                renderer.render(context, "SALVAGE CONTRACTS", x + 30, j + 130);
            }
            if (iv.questEntrySelected == 6) {
                renderer.render(context, "HUNTING GROUNDS", x + 40, j + 155);
            } else {
                renderer.render(context, "HUNTING GROUNDS", x + 30, j + 155);
            }
            if (iv.questEntrySelected == 7) {
                renderer.render(context, "MELEE PIT", x + 40, j + 180);
            } else {
                renderer.render(context, "MELEE PIT", x + 30, j + 180);
            }
            if (iv.questEntrySelected == 8) {
                renderer.render(context, "THE ARENA", x + 40, j + 205);
            } else {
                renderer.render(context, "THE ARENA", x + 30, j + 205);
            }
            if (iv.questEntrySelected == 9) {
                renderer.render(context, "REBEL CAMPS", x + 40, j + 230);
            } else {
                renderer.render(context, "REBEL CAMPS", x + 30, j + 230);
            }
            if (iv.questEntrySelected == 10) {
                renderer.render(context, "REBEL OUTPOSTS", x + 40, j + 255);
            } else {
                renderer.render(context, "REBEL OUTPOSTS", x + 30, j + 255);
            }
            if (iv.questEntrySelected == 11) {
                renderer.render(context, "RELIC RUINS", x + 40, j + 280);
            } else {
                renderer.render(context, "RELIC RUINS", x + 30, j + 280);
            }
            if (iv.questEntrySelected == 12) {
                renderer.render(context, "TALLNECKS", x + 40, j + 305);
            } else {
                renderer.render(context, "TALLNECKS", x + 30, j + 305);
            }
            if (iv.questEntrySelected == 13) {
                renderer.render(context, "CAULDRONS", x + 40, j + 330);
            } else {
                renderer.render(context, "CAULDRONS", x + 30, j + 330);
            }
            if (iv.questEntrySelected == 14) {
                renderer.render(context, "COLLECTABLES", x + 40, j + 355);
            } else {
                renderer.render(context, "COLLECTABLES", x + 30, j + 355);
            }
        }
    }
